...
% Compute the activation values of the hidden layer. We multiply the intensity
% of each pixel value by the weights of the input neurons. This is vectorized to
